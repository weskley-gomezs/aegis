    ...
    <section className="relative py-24 bg-white overflow-hidden" id="about">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden border border-gray-200 group">
              <img 
              ...
              {/* Floating Badge */}
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-white/90 backdrop-blur-md border border-gray-200 flex justify-between items-center">
                <div>
                  <span className="font-mono text-[10px] text-neon-green font-bold uppercase tracking-[0.2em] block mb-1">FUNDADOR & CTO</span>
                  <h3 className="font-sans text-lg font-bold text-gray-900">Weskley Gomes</h3>
                </div>
                <a 
                  href="https://www.linkedin.com/in/weskley-gomes-250825308/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-gray-200 bg-gray-100 text-gray-900 hover:border-neon-green hover:text-neon-green transition-all duration-300"
          ...
          >
            ...
            <h2 className="font-sans text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl mb-8 leading-[1.1]">
            ...
            <div className="space-y-6 text-gray-600 text-base md:text-lg leading-relaxed">
              <p>
                Sou <span className="text-gray-900 font-semibold">Weskley Gomes</span>, fundador da AEGIS, empresa especializada no desenvolvimento de sistemas personalizados, plataformas web e soluções digitais para empresas.
              </p>
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12 pt-12 border-t border-gray-200">
              {pillars.map((pillar, i) => (
                <div key={i} className="space-y-3">
                  ...
                  <h4 className="text-xs font-bold text-gray-900 uppercase tracking-wider">{pillar.title}</h4>
                  <p className="text-[11px] text-gray-600 leading-normal">{pillar.description}</p>
                </div>
              ))}
            </div>

            <div className="mt-12">
              <div className="inline-flex items-center gap-2 p-4 rounded-2xl bg-gray-50 border border-gray-200">
