    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
                ...
                >
                  ...
                  <div className="w-full lg:w-[46%]">
                    <motion.div
                      ...
                      className="group glass rounded-3xl p-8 hover:border-neon-green/20 hover:bg-white/[0.02] transition-all duration-300 relative overflow-hidden border border-white/5"
                    >
                      ...
                      <div className="flex items-start gap-5">
                        <span className="font-mono text-3xl font-extrabold text-white/10 group-hover:text-neon-green/40 transition-colors leading-none shrink-0 mt-1">
                          {step.stepNumber}
                        </span>
                        <div>
                          <h3 className="font-sans text-xl font-bold text-white group-hover:text-neon-green transition-colors">
                            {step.title}
                          </h3>
                  ...
                  <div className="relative flex items-center justify-center w-full lg:w-[8%] shrink-0 h-10 lg:h-auto">
                    <div className="relative flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-[#0a0a0a] text-neon-green group shadow-md">
                      <span className="h-3.5 w-3.5 rounded-full bg-white/20 group-hover:bg-neon-green transition-colors" />
                    </div>
                  </div>
        ...
        <div className="mt-20 flex flex-col items-center justify-center text-center">
          <div className="flex items-center gap-2 rounded-full border border-white/5 bg-white/[0.01] px-5 py-2 text-xs text-gray-400 font-mono">
